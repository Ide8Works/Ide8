  ...
  return (
    ...
    >
      <div className="absolute z-10 px-4 sm:px-6 md:px-10 top-1/6 sm:top-1/5 md:top-20 flex flex-col items-center text-center text-white font-aglight">
        <h1 className="font-semibold text-4xl sm:text-6xl md:text-7xl leading-tight">
          got an <span className="text-black font-agheavy">idea</span>?
        </h1>
        <h2 className="mt-3 sm:mt-4 max-w-[90%] sm:max-w-2xl md:max-w-3xl text-sm sm:text-lg md:text-xl leading-relaxed font-courier">
          <span className="italic">everyone</span> has but, it’s nothing without{" "}
