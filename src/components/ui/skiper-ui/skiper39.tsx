...
const CrowdCanvas = ({ src, rows = 15, cols = 7 }: CrowdCanvasProps) => {
  ...
  return (
    <canvas ref={canvasRef} className="absolute bottom-0 h-[85vh] w-full" />
  );
};

const Skiper39 = () => {
  return (
    <div className="relative h-full w-full bg-[#ffa800]">
      <div className="absolute bottom-0 h-full w-screen">
        <CrowdCanvas src="/media/image.png" rows={15} cols={7} />
      </div>
    </div>
  );
};
